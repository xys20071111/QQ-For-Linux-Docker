...
RUN apt update && \
    apt upgrade -y && \
    apt install -y sudo libgbm1 libasound2 fonts-wqy-zenhei libnotify-bin firefox-esr firefox-esr-l10n-zh-cn locales fonts-noto-color-emoji /root/linuxqq_3.0.0-565_amd64.deb;
